        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="float-right">
              <div class="container">
                  <div class="col-xs-4">
                <form action="{{ action('PostController@index') }}" method="get" role="search">
                    {{ csrf_field() }}
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                   @foreach ($poto as $key => $pos)
                <tr>
                  <td>{{++$key}}</td>
                   <td><img width="100px" src="{{asset('uploads/schoolphoto/'.$pos->image)}}" alt="" /></td>
