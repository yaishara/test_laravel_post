      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('admins/post/create')}}"><i class="fa fa-circle-o"></i> Create</a></li>
            <li><a href="{{url('admins/post')}}"><i class="fa fa-circle-o"></i> view</a></li>
          </ul>
        </li>
      </ul>
    </section>
